...
Bare project names start or attach the project. Recognized commands: board-skill, new, register, upgrade, add-role, present, set-vcs-close-role, agy-credential, role-prompt, onboarding-readiness, stop, teardown, status, validate-models.
```
<!-- switchyard-help:end -->
