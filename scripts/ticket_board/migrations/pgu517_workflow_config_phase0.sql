...
INSERT INTO ticket_board.workflow_stages (
    ...
    ('user_review', 'UAT', 6, ARRAY['director']::text[], 'needs_user_signoff', 'director_review', 'user_signoff', false),
...
VALUES
    ('draft', 'analysis', 'release_draft', ARRAY['director', 'user']::text[]),
    ...
    ('audit', 'user_review', 'audit_sign_off', ARRAY['audit']::text[]),
    ...
    ('user_review', 'inspection', 'route', ARRAY['director']::text[]),
    ('user_review', 'director_review', 'user_sign_off', ARRAY['user']::text[]),
    ('user_review', 'audit', 'route', ARRAY['director']::text[]),
    ('user_review', 'analysis', 'user_reopen', ARRAY['user']::text[]),
    ('user_review', 'analysis', 'route', ARRAY['director']::text[]),
    ('user_review', 'backlog', 'defer', ARRAY['director']::text[]),
    ('user_review', 'cancelled', 'cancel', ARRAY['director']::text[]),
    ('director_review', 'done', 'mark_done', ARRAY['director']::text[]),
    ('director_review', 'in_progress', 'route', ARRAY['director']::text[]),
    ('director_review', 'analysis', 'user_reopen', ARRAY['user']::text[]),
    ...
    ('done', 'analysis', 'user_reopen', ARRAY['user']::text[]),
