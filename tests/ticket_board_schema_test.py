...
def main() -> int:
    ...
    assert "create or replace function ticket_board.require_stage_owner_assignee" in executable_schema_lower
    assert "is not an owner of stage" in schema
